...
public abstract class Buffer implements IBuffer
{
	...
	protected HashMap memoryBuffer = new HashMap();
	long m_hits = 0;
	...
	{
		byte[] ret;
		Entry e = (Entry) memoryBuffer.get(new Integer(id));
	...
	{
		Integer ID = id;
		Entry e = (Entry) memoryBuffer.get(ID);
		if (e != null)
		{
	...
	public void flush()
	{
        for (Object o : memoryBuffer.entrySet()) {
